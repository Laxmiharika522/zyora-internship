# Zyora Frontend Developer Internship
...
- Install Node.js LTS and Visual Studio Code.
- Create a public GitHub repository.
- Build a **Developer Launch Page** using HTML.
- Document the project with a professional `README.md`.

---

## Developer Launch Page

The `index.html` file serves as my Developer Launch Page and includes:
